...
module.exports = _.class({
    ...
    initStorage: function(server) {
        ...
        this.initDB(function(){
            ...
            setTimeout(this.fullSynchronization.bind(this, true));
    ...
    insertData: function(data, callback) { // overwrite function
        ...
        this._sql.insertData.run(this._sql.insertData._filterParams(data), function(err) {
        ...
        this.requestToNodes({
            ...
            onFinish: function(errors) {
                var syncSources = function(){
                    ...
                    // finish sync
                    if(!errors) {
                        self.saveInfo({ tLastSync: tStart });
